...
#define My_Button_Pin GPIO_PIN_0
#define My_Button_GPIO_Port GPIOA
...
#define My_Blue_LED_Pin GPIO_PIN_6
#define My_Blue_LED_GPIO_Port GPIOB
#define My_Green_LED_Pin GPIO_PIN_7
#define My_Green_LED_GPIO_Port GPIOB
